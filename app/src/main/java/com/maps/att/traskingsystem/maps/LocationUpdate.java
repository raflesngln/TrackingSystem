...
//        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom((jakarta),12.0f));
        ...
        mMap.addMarker(new MarkerOptions().position(jakarta).title("Posisi saya").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom((jakarta),15.0f));
        Log.d("My Location is =====> ", location.toString());
        Toast.makeText(this, "haiiiii"+location.getLatitude()+"dann "+location.getLongitude(), Toast.LENGTH_LONG).show();
